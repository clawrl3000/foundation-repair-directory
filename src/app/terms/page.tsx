...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://foundationscout.com/terms' },
  openGraph: {
    title: 'Terms of Service | FoundationScout',
    description: 'FoundationScout terms of service — rules governing use of our foundation repair contractor directory.',
    url: 'https://foundationscout.com/terms',
  },
}
    ...
    <div className="relative flex min-h-screen flex-col bg-white font-display text-slate-900 antialiased">
      ...
      <main className="flex-1">
        <div className="max-w-3xl mx-auto px-6 py-16">
          ...
          <h1 className="font-display text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.1] text-slate-900 mb-2">Terms of Service</h1>
          <p className="text-sm text-slate-400 mb-10">Last updated: February 22, 2026</p>

          <div className="prose prose-slate max-w-none space-y-8 text-slate-600 leading-relaxed animate-on-scroll">
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">1. Acceptance of Terms</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">2. Description of Service</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">3. No Guarantee or Warranty</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">4. Limitation of Liability</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">5. User Conduct</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">6. Contractor Listings</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">7. Intellectual Property</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">8. Third-Party Links</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">9. Changes to Terms</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">10. Contact Us</h2>
