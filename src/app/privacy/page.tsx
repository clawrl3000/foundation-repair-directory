...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://foundationscout.com/privacy' },
  openGraph: {
    title: 'Privacy Policy | FoundationScout',
    description: 'FoundationScout privacy policy — how we collect, use, and protect your personal information when using our foundation repair contractor directory.',
    url: 'https://foundationscout.com/privacy',
  },
}
    ...
    <div className="relative flex min-h-screen flex-col bg-white font-display text-slate-900 antialiased">
      ...
      <main className="flex-1">
        <div className="max-w-3xl mx-auto px-6 py-16">
          ...
          <h1 className="font-display text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.1] text-slate-900 mb-2">Privacy Policy</h1>
          ...
          <div className="prose prose-slate max-w-none space-y-8 text-slate-600 leading-relaxed animate-on-scroll">
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">1. Who We Are</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">2. Information We Collect</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">3. How We Use Your Information</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">4. Information Sharing</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">5. Data Security</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">6. Cookies & Analytics</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">7. Your Rights</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">8. Contact Us</h2>
            ...
            <section className="animate-on-scroll">
              <h2 className="font-display text-xl font-bold text-slate-800 mb-3">9. Changes to This Policy</h2>
