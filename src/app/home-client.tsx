            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-10">
              <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center pt-24 sm:pt-28 lg:pt-32 pb-12 sm:pb-16 lg:pb-20">
                ...
                <div className="space-y-6 lg:space-y-8">
                  ...
                  <AnimatedSearchForm
                    onSearch={(query) => {
                      trackSearch(query, 'Homepage Hero')
                    }}
                  ...
                  <div className="absolute -bottom-4 -left-6 bg-white rounded-xl shadow-xl px-5 py-4 border border-slate-100">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center">
                        <span className="material-symbols-outlined text-xl text-green-600" aria-hidden="true">verified</span>
                      </div>
                      <div>
          ...
          <section className="bg-slate-50 py-20 lg:py-28 border-y border-slate-200 animate-on-scroll">
            <div className="mx-auto max-w-7xl px-6 lg:px-10">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <Link href="/states" className="relative rounded-xl overflow-hidden border border-slate-200 h-80 block group cursor-pointer bg-gradient-to-br from-blue-50 to-amber-50">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <div className="inline-flex items-center justify-center w-24 h-24 bg-white rounded-full shadow-lg border border-slate-200 mb-4 group-hover:scale-110 transition-transform">
                      ...
                      <p className="text-slate-600">Licensed contractors in all 50 states</p>
                      <div className="flex items-center justify-center gap-2 mt-4 text-primary font-semibold">
                  ...
                  <div className="absolute bottom-6 left-6">
                    <div className="flex items-center gap-2 text-slate-900 font-bold">
                      <span className="material-symbols-outlined text-xl text-primary" aria-hidden="true">pin_drop</span>
                      50 States Served
                    </div>
                  </div>
                </Link>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
                ...
                <div className="flex flex-col items-center text-center group animate-on-scroll animate-delay-100">
                  <div className="size-20 rounded-full bg-white/10 flex items-center justify-center mb-6 border-2 border-white/30 group-hover:bg-amber-500 group-hover:border-amber-400 group-hover:scale-110 transition-all duration-300 relative">
                    <span className="material-symbols-outlined text-3xl text-white group-hover:text-white" role="img" aria-label="Search for contractors">search</span>
                  ...
                  <p className="text-slate-300 text-sm leading-relaxed">Find local experts in your area by entering your ZIP code.</p>
                </div>
                
                {/* Step 2 */}
                <div className="flex flex-col items-center text-center group animate-on-scroll animate-delay-200">
                  <div className="size-20 rounded-full bg-white/10 flex items-center justify-center mb-6 border-2 border-white/30 group-hover:bg-amber-500 group-hover:border-amber-400 group-hover:scale-110 transition-all duration-300 relative">
                    <span className="material-symbols-outlined text-3xl text-white group-hover:text-white" role="img" aria-label="Compare contractors">rule</span>
                ...
                <div className="flex flex-col items-center text-center group animate-on-scroll animate-delay-300">
                  <div className="size-20 rounded-full bg-white/10 flex items-center justify-center mb-6 border-2 border-white/30 group-hover:bg-amber-500 group-hover:border-amber-400 group-hover:scale-110 transition-all duration-300 relative">
                    <span className="material-symbols-outlined text-3xl text-white group-hover:text-white" role="img" aria-label="Contact contractors">forum</span>
                ...
                <div className="flex flex-col items-center text-center group animate-on-scroll animate-delay-400">
                  <div className="size-20 rounded-full bg-white/10 flex items-center justify-center mb-6 border-2 border-white/30 group-hover:bg-amber-500 group-hover:border-amber-400 group-hover:scale-110 transition-all duration-300 relative">
                    <span className="material-symbols-outlined text-3xl text-white group-hover:text-white" role="img" aria-label="Get protection">house_with_shield</span>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16 animate-on-scroll">
                <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-4 py-2 mb-6">
                  <span className="material-symbols-outlined text-xl text-primary" aria-hidden="true">construction</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {SERVICES.map((service, index) => (
                  <div key={service.slug} className={`service-card group flex flex-col bg-slate-50 border-2 border-slate-200 rounded-xl p-6 animate-on-scroll animate-delay-${(index + 1) * 100}`}>
          ...
          <section className="py-20 lg:py-28 px-6 bg-slate-50 animate-on-scroll">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm text-center hover:shadow-xl hover:-translate-y-2 transition-all duration-300 animate-on-scroll animate-delay-100">
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm text-center hover:shadow-xl hover:-translate-y-2 transition-all duration-300 animate-on-scroll animate-delay-200">
              ...
              {/* Benefits List */}
              <div className="bg-white border border-slate-200 rounded-2xl p-8 lg:p-12 mb-16">
                <h3 className="text-2xl font-bold text-slate-900 mb-8 text-center">Why Choose FoundationScout?</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-900 mb-1">Licensed & Insured Only</h4>
                      <p className="text-slate-600 text-sm">Every contractor is pre-screened with active licenses and insurance verification.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-900 mb-1">Local Expertise</h4>
                      <p className="text-slate-600 text-sm">Contractors understand your local soil conditions and building codes.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-900 mb-1">Warranty Protection</h4>
                      <p className="text-slate-600 text-sm">All work comes with comprehensive warranties for your peace of mind.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center">
                <div className="inline-flex items-center gap-3 bg-blue-50 px-6 py-3 rounded-full mb-6">
                  <span className="material-symbols-outlined text-xl text-primary" aria-hidden="true">verified</span>
                  <span className="text-sm font-bold text-primary">Join thousands of satisfied homeowners</span>
                </div>
                <div>
                  <button 
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center">
                <div className="group animate-on-scroll">
                  <div className="h-32 bg-white border-2 border-slate-200 rounded-xl shadow-lg flex flex-col items-center justify-center p-6 hover:shadow-xl hover:-translate-y-2 hover:border-blue-300 hover:shadow-blue-100/50 transition-all duration-300 hover:scale-105">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="material-symbols-outlined text-4xl text-blue-600 animate-pulse-gentle" role="img" aria-label="BBB Accredited">verified_user</span>
                ...
                <div className="group animate-on-scroll animate-delay-200">
                  <div className="h-32 bg-white border-2 border-slate-200 rounded-xl shadow-lg flex flex-col items-center justify-center p-6 hover:shadow-xl hover:-translate-y-2 hover:border-green-300 hover:shadow-green-100/50 transition-all duration-300 hover:scale-105">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="material-symbols-outlined text-4xl text-green-600" role="img" aria-label="ICC-ES Code Certified">engineering</span>
                ...
                <div className="group animate-on-scroll animate-delay-300">
                  <div className="h-32 bg-white border-2 border-slate-200 rounded-xl shadow-lg flex flex-col items-center justify-center p-6 hover:shadow-xl hover:-translate-y-2 hover:border-blue-300 hover:shadow-blue-100/50 transition-all duration-300 hover:scale-105">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="material-symbols-outlined text-4xl text-blue-600" role="img" aria-label="Insured contractors">security</span>
                    ...
                    <div className="flex items-center gap-1 mt-2">
                      <span className="material-symbols-outlined text-xl text-blue-600" aria-hidden="true">shield</span>
                ...
                <div className="group animate-on-scroll animate-delay-400">
                  <div className="h-32 bg-white border-2 border-slate-200 rounded-xl shadow-lg flex flex-col items-center justify-center p-6 hover:shadow-xl hover:-translate-y-2 hover:border-amber-300 hover:shadow-amber-100/50 transition-all duration-300 hover:scale-105">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="material-symbols-outlined text-4xl text-amber-600" role="img" aria-label="5-Year Warranty">workspace_premium</span>
                    ...
                    <div className="flex items-center gap-1 mt-2">
                      <span className="material-symbols-outlined text-xl text-amber-600" aria-hidden="true">verified</span>
                ...
                <div className="mt-6">
                  ...
                  >
                    <span className="relative z-10 flex items-center gap-2">
                      <span className="material-symbols-outlined text-xl" role="img" aria-label="Schedule">schedule</span>
              ...
              <div>
                ...
                <ul className="flex flex-col gap-4 text-sm text-slate-600">
                  <li className="flex gap-3">
                    <span className="material-symbols-outlined text-xl text-primary" aria-hidden="true">call</span>
                    1-800-FOUND-DIR
                  </li>
                  <li className="flex gap-3">
                    <span className="material-symbols-outlined text-xl text-primary" aria-hidden="true">mail</span>
